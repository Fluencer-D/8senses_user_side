      ...
      <div className="content-container relative z-10 text-center px-6 w-[753px] h-[251px]">
        ...
        <div className="button-group flex justify-center gap-6 mt-8">
          <button
            ...
            className="w-[250px] h-[60px] bg-[#C83C92] hover:bg-[#b8327f] text-white px-8 py-4 text-xl rounded-full transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-[#C83C92] focus:ring-opacity-50 shadow-lg flex items-center justify-center"
          >
            Make an Appointment
          </button>
        </div>
