    ...
    <div className="flex flex-wrap justify-center sm:justify-start gap-2 sm:gap-3 md:gap-4 mt-4 sm:mt-6">
      {categories.map((category) => (
        <button
          ...
          className={`px-3 sm:px-5 md:px-9 py-2 sm:py-3 rounded-full border border-gray-400 text-xs sm:text-sm md:text-md transition-all duration-200 ${
            selectedCategory === category ? "bg-[#245BA7] text-white" : "bg-[#F8FBFF] text-[#456696]"
          }`}
        >
          {category}
        </button>
