      ...
      <main className="px-0 py-12">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center text-[#245BA7]">
              ...
              <p className="font-nav_link_font text-lg md:text-xl leading-relaxed tracking-[0.02em] text-[#456696] max-w-6xl mx-auto text-left">
                The clinic's mission is to empower children to reach their full potential through tailored, evidence-based treatments while providing families with practical strategies and unwavering support. Dr. Shrruti, is a seasoned Pediatric Occupational Therapist dedicated to empowering children with neurological and developmental challenges. Dr. Shrruti specializes in Occupational Therapy, Sensory Integration, Neuro-developmental disorders particularly in the areas of Autism, ADHD, and Sensory Processing disorders. Her expertise and compassionate approach make her a trusted name in the field, transforming lives and fostering brighter futures for countless families. <br /> <br /> Dr. Parul Diwan is an experienced Audiology & Pediatric Speech Therapist, a facility dedicated to diagnosing and treating speech, language, and developmental challenges in children. The clinic addresses a range of issues, including Receptive and Expressive Language disorders, Articulation and Phonological difficulties, Motor Speech and Fluency disorders, Hearing impairments, and Voice-related concerns.
              </p>
        ...
        <section className="text-center py-16 px-8 md:px-20 lg:px-32 mb-20">
          ...
          <p className="text-[#456696] text-xl mt-4 max-w-2xl mx-auto">
            Dedicated specialists in Pediatric Occupational Therapy and Speech Therapy, helping children overcome challenges with expert care and compassion.
          </p>
          ...
          <div className="flex flex-col md:flex-col justify-center items-center gap-16 mt-16">
            ...
            <div className="text-center max-w-2xl">
              <div className="relative inline-block">
                <Image src={AbtTeam1} alt="Dr. Shrruti Paatil" width={200} height={200} className="rounded-full mx-auto shadow-lg" />
                <div className="hidden 2xl:block absolute top-15 -left-92 -z-10">
                  <DottedPattern />
                </div>
              </div>
              <h3 className="text-2xl font-semibold text-[#1E437A] mt-6">Dr. Shrruti Paatil</h3>
              <p className="text-[#456696] font-medium">Pediatric Occupational Therapist</p>
              <p className="text-[#456696] mt-4 text-lg">
                <span className='font-bold text-[#456696]'>Commitment to Integrity:</span> Dr. Shrruti's commitment to integrity is at the core of everything
